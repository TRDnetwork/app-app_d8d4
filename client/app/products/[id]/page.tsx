    ...
    <div className="min-h-screen bg-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 gap-8">
            ...
            <div className="flex gap-2 mt-4 overflow-x-auto pb-2">
              {product.images.map((img, i) => (
                <img
                  ...
                  className="w-20 h-20 object-cover border border-gray-200 rounded cursor-pointer hover:border-orange-500 flex-shrink-0"
                />
              ))}
            </div>
          </div>
          ...
          <div>
              ...
              <div className="flex gap-2 overflow-x-auto pb-2">
                {product.variants.map((variant) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-md border text-sm font-medium transition whitespace-nowrap flex-shrink-0 ${
                      variant.inStock
            ...
            <div className="flex items-center mb-6">
              ...
              <select className="border border-gray-300 rounded px-3 py-2 text-sm flex-1 max-w-[120px]">
                {[...Array(10)].map((_, i) => (
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              ...
              <Button size="lg" variant="secondary" className="flex-1 min-h-[48px]">
                Buy Now
              </Button>
            </div>
        ...
        <section className="mt-16">
          ...
          <div className="flex flex-col sm:flex-row items-center bg-gray-50 p-4 rounded-lg gap-4">
            <div className="flex items-center space-x-4 flex-1 overflow-x-auto pb-2">
            ...
            <div className="ml-0 sm:ml-8 text-right w-full sm:w-auto">
        ...
        <Tabs defaultValue="reviews" className="mt-16">
          <TabsList className="flex flex-wrap">
            ...
            <TabsTrigger value="reviews" className="flex-1 min-w-[120px]">Reviews ({product.reviews})</TabsTrigger>
            <TabsTrigger value="qa" className="flex-1 min-w-[120px]">Q&A</TabsTrigger>
          </TabsList>
